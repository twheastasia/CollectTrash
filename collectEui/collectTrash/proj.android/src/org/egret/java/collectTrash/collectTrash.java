package org.egret.java.collectTrash;
...
public class collectTrash extends Activity {
    ...
    private static final String EGRET_PUBLISH_ZIP = "game_code_160625124741.zip";
    protected static final String TAG = "collectTrash";
